...
Implements an MCP server that exposes JARVIS tools as MCP-compatible endpoints.
This allows external AI agents/clients to use JARVIS capabilities via MCP protocol.
...
from jarvis.modules import search, news, memory, image, music
    ...
    if method == "initialize":
        return {
            ...
            "result": {
                ...
                "capabilities": {"tools": {}},
                "serverInfo": {"name": "jarvis-mcp", "version": "2.0.0"},
            },
        }
